...
if __name__=='__main__':
  ...
  parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/spam_potted_meat_can/mesh/converted_obj_000009.obj') #textured_simple.obj does not exist
  parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/spam_potted_meat_can')
  ...
  while km.key != 'q':
    ...
    if i==0:
      ...
      yolo_world.set_classes(['blue container', "blue can", 'blue and gold container', 'food can', 'food container'])
      results = yolo_world.predict(color, conf=0.1) # 0.25 default
      results[0].show()
      max_conf = -1.0
      best_detection = None
